    ...
    return(
        <div className="container about-section" id='about'>
            ...
            <p>
                ...
                <br />
                When I'm not coding, you'll often find me tackling algorithmic challenges or learning the latest trends in web development. <br />
                <br />
                I aim to craft seamless digital experiences that combine functionality, aesthetics, and innovation.
            </p>
        </div>
    )
}